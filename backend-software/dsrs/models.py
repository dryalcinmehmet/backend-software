...
class DSR(models.Model):
    ...
    territory = models.ForeignKey(
        Territory, related_name="dsrs", on_delete=models.CASCADE, null=True
    )
    currency = models.ForeignKey(
        Currency, related_name="dsrs", on_delete=models.CASCADE, null=True
    )
...
class DSP(models.Model):
    ...
    usages = models.FloatField(null= True, blank=True)
    revenue = models.FloatField(null= True, blank=True)
    dsrs = models.ForeignKey(
        DSR, related_name="dsp", on_delete=models.CASCADE
    )